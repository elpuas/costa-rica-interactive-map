 ...
 */
function costa_rica_map_add_meta_boxes() {
    add_meta_box(
        'tour_coordinates',
        __('Tour Location', 'costa-rica-map'),
        'costa_rica_map_coordinates_meta_box',
        'tour',
        'normal',
        'high'
    );
 ...
 */
function costa_rica_map_coordinates_meta_box($post) {
 ...
 * Save meta box data
 */
function costa_rica_map_save_meta_box_data($post_id) {
...
// Hook into WordPress
add_action('add_meta_boxes', 'costa_rica_map_add_meta_boxes');
add_action('save_post', 'costa_rica_map_save_meta_box_data'); 